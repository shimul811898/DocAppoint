...
const Banner = () => {
  return (
    <section className="relative max-w-7xl mx-auto mb-32 overflow-hidden rounded-[40px] bg-gradient-to-br from-[#eef5ff] via-white to-[#e6fffb] shadow-[0_20px_80px_rgba(30,99,255,0.12)]">
      <div className="absolute top-0 left-0 w-72 h-72 bg-[#1E63FF]/10 rounded-full blur-3xl" />
      <div className="absolute bottom-0 right-0 w-72 h-72 bg-[#18C7C9]/10 rounded-full blur-3xl" />
      ...
      <div className="relative max-w-6xl mx-auto flex flex-col lg:flex-row items-center justify-between px-6 sm:px-10 lg:px-14 pt-14 lg:pt-20 gap-12">
        ...
        <div className="relative lg:w-1/2 flex justify-center lg:justify-end items-end">
          <div className="absolute bottom-8 w-[320px] h-[320px] bg-gradient-to-r from-[#1E63FF] to-[#18C7C9] rounded-full blur-3xl opacity-20" />

          <div className="relative z-10">
            <Image
              src="/assets/doctor.png"
              alt="Professional doctor standing and smiling"
              width={500}
              height={650}
              priority
              className="h-auto max-w-full lg:max-w-[500px] object-contain drop-shadow-[0_25px_50px_rgba(0,0,0,0.25)]"
            />
          </div>
        </div>
